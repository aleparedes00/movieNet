...
INSERT INTO FilmSet (Titre, Genres, Synopsis, Director) VALUES ('The Club', 'Comedy', 'A crisis counselor is sent by the Catholic Church to a small Chilean beach town where disgraced priests and nuns, suspected of crimes ranging from child abuse to baby-snatching from unwed mothers, live secluded, after an incident occurs.', 'Pablo Larrain');
INSERT INTO FilmSet (Titre, Genres, Synopsis, Director) VALUES ('The Devil and Father Amorth', 'Documentary', 'Father Gabriele Amorth performs his ninth exorcism on an Italian woman', 'William Friedkin');
INSERT INTO FilmSet (Titre, Genres, Synopsis, Director) VALUES ('Godard Mon Amour', 'Biography', 'During the making of one of his films, French film director Jean-Luc Godard falls in love with 17-year old actress Anne Wiazemsky and later marries her.', 'Michel Hazanavicius');
INSERT INTO FilmSet (Titre, Genres, Synopsis, Score, Director) VALUES ('Isle of Dogs', 'Comedy', 'Set in Japan, Isle of Dogs follows a boy s odyssey in search of his lost dog.', 4.4, 'Wes Anderson');
INSERT INTO FilmSet (Titre, Genres, Synopsis, Score, Director) VALUES ('Call Me by Your Name', 'Drama', 'In 1980s Italy, a romance blossoms between a seventeen year-old student and the older man hired as his father s research assistant.', 4.7, 'Luca Guadagnino');
